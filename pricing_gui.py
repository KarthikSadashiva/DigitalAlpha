...
def printYM():
    ...
    dataset = pd.read_excel(r"C:\Users\user.A713DCOK\Desktop\store-dataset.xlsx")
...
loadButton = tk.Button(root, text='Load Data for selected Year and Month', command=populateData)
loadButton.pack()
root.mainloop()
