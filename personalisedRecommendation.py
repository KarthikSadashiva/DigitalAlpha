...
def get_recommendations(quar, num_best_cust, num_best_prod, conf):
    ...
    data_q16 = data.loc[(data['Order Date'] <= quater16) & (data['Order Date'] > quater15)]
    data_q15 = data.loc[(data['Order Date'] <= quater15) & (data['Order Date'] > quater14)]
    data_q14 = data.loc[(data['Order Date'] <= quater14) & (data['Order Date'] > quater13)]
...
lineLabel = tk.Label(root, text = '_'*160)
lineLabel.place(relx = 0.05, rely = 0.25)
lineLabel1 = tk.Label(root, text = '_'*160)
